...
from core.jwt import (create_access_token, get_current_user, get_password_hash, verify_password)
...
from api.services.fetchapi import FetchAgricultureManagerment
import asyncio
...
class UserController(metaclass=SingletonMeta):
    def __init__(self, ):
        ...
        self.vehicleManagementCrud = FetchAgricultureManagerment()
