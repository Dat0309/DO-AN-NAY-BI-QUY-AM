from api.models.role import (RoleModel, RoleModelListOut, RoleModelOut, UpdateRoleModel)
from core.jwt import get_current_user
from fastapi import APIRouter, Depends, Query
from utils.pagination import pagination_info
from utils.decorators import check_is_admin, check_is_admin_or_permission
