...
app = FastAPI(
    openapi_url='/api/v1/yolo-identity-agriculture/openapi.json',
    docs_url='/api/v1/yolo-identity-agriculture/docs',
    redoc_url='/api/v1/yolo-identity-agriculture/redoc',
    title='YOLO identity-agriculture',
    version='1.0.0',
)
...
router = APIRouter(prefix='/api/v1/yolo-identity-agriculture',responses={'404':{'description':'Not found test'}})
